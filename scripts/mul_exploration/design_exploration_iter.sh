...
configGenScript=${baseDir}/final-year-project/scripts/mul_exploration/generate_config.py
hlsReportDir=${baseDir}/design_exploration_hls_prj/solution1/syn/report
hlsScript=${baseDir}/final-year-project/scripts/mul_exploration/run_hls.tcl
vivadoScript=${baseDir}/final-year-project/scripts/mul_exploration/run_vivado.tcl
reportLogDir=${baseDir}/final-year-project/design_exploration/pointwise_mul/reports
...
do
  ...
  do
    ...
    then
      python $configGenScript --N $N --in_width $IN_WIDTH --default_muls $N --fabric_muls 0 --dsp_muls 0 --ram_muls 0 --ram_partition_factor 1 --dual_port false --lut_ram false
    ...
    then
      python $configGenScript --N $N --in_width $IN_WIDTH --default_muls 0 --fabric_muls $N --dsp_muls 0 --ram_muls 0 --ram_partition_factor 1 --dual_port false --lut_ram false
    ...
    then
      ...
      then
        python $configGenScript --N $N --in_width $IN_WIDTH --default_muls 0 --fabric_muls 0 --dsp_muls $N --ram_muls 0 --ram_partition_factor 1 --dual_port false --lut_ram false
    ...
    then 
      ...
      then
        python $configGenScript --N $N --in_width $IN_WIDTH --default_muls 0 --fabric_muls 0 --dsp_muls 0 --ram_muls $N --ram_partition_factor $N --dual_port false --lut_ram false
      ...
      then
        python $configGenScript --N $N --in_width $IN_WIDTH --default_muls 0 --fabric_muls 0 --dsp_muls 0 --ram_muls $N --ram_partition_factor $N --dual_port true --lut_ram false
    ...
    then
      ...
      then
        python $configGenScript --N $N --in_width $IN_WIDTH --default_muls 0 --fabric_muls 0 --dsp_muls 0 --ram_muls $N --ram_partition_factor 1 --dual_port false --lut_ram true
      ...
      then
        python $configGenScript --N $N --in_width $IN_WIDTH --default_muls 0 --fabric_muls 0 --dsp_muls 0 --ram_muls $N --ram_partition_factor 1 --dual_port true --lut_ram true
