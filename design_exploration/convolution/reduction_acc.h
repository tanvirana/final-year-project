#ifndef REDUCTION_ACC_H
#define REDUCTION_ACC_H
...
void process_layer(int *layer_in_start, int *layer_out_start, ap_uint<CONFIG_IN_WIDTH * 2 + CONFIG_NUM_LAYERS> partial_sums[CONFIG_NUM_PARTIAL_RESULTS], const ap_uint<IN_WIDTH + 1> *add_table) {
